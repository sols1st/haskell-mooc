...
binomial n 0 = 1
binomial 0 _ = 0
binomial b k = binomial (b - 1) k + binomial (b - 1) (k - 1)
...
oddFactorial 1 = 1
oddFactorial x = (if odd x then x else 1) * oddFactorial (x - 1)
...
smallestDivisor 0 = 0
smallestDivisor 1 = 1
smallestDivisor n = smallestDivisorHelper 2 n
  where
    smallestDivisorHelper a n =
      if mod n a == 0
        then a
        else smallestDivisorHelper (a + 1) n
